...
from FL.models.cifar_cnn_3conv_layer import cifar_cnn_3conv, cifar_cnn_3conv_specific, cifar_cnn_3conv_shared
from FL.models.cifar_resnet import ResNet18, ResNet34, ResNet50, ResNet101, ResNet152
from FL.models.mnist_cnn import mnist_lenet
from FL.models.mnist_logistic import LogisticRegression
from FL.models.cifar_light import Cifar_light
    ...
    if args.mtl_model:
        ...
        if args.dataset == 'cifar10':
            if args.model == 'cnn_complex':
                ...
                specific_layers = None
            elif args.model == 'cifar_light':
                shared_layers = Cifar_light()
                specific_layers = None
            else:
                raise ValueError('Model not implemented for CIFAR-10')
